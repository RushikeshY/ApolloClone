      ...
      <div style={{ background: "white", width: "78%", margin: "auto" ,backgroundColor:"white"}}>
            ...
            <div className="home3d">
              ...
              <div  style={{paddingTop:"8px"}}>
                <Link
                  ...
                  to={"/"}
                >
                  Explore the Apollo Kavach Program
                </Link>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <p className="para">
            ...
            medical doctors are available at Apollo 24|7. Video call or chat
          ...
          <p className="para">
            Apollo pharmacy is the most credible and established online pharmacy
            in India. It delivers 100% original medicines and products. Apollo
          ...
          <p className="para">
            Rapid deliveries of medicines are available online at Apollo
          ...
          <p className="para">
            ...
            treatment. Apollo 24|7 provides blood sample testing at your
          ...
          <p className="para">
            Manage your health with prompt health check-ups from Apollo 24|7. We
            ...
            pathology labs here at Apollo 24|7.{" "}
          </p>

          <h6 className="h612">Other Services Offered by Apollo 24|7</h6>
          <p className="para">
            pollo Circle Membership: Premium Healthcare Program Apollo 24/7
            ...
            priority access to Apollo’s best doctors, personalised care, unique
          ...
          <p className="para">
            Apollo ProHealth Program is an exclusive end-to-end personalised
          ...
          <p className="para">
            ...
            using the Apollo 24|7 app and website.
          </p>
        </div>
        <br />
        <div>
