...
box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 12px;`
 ...
 const DoctorsDetails = () => {
  ...
  return (
        ...
        <div style={{backgroundColor:"#eff0ed",height:"1000px"}}>
        ...
        <div style={{display:"flex",gap:"10px"}}>
             <div style={{fontFamily:"IBM Plex Sans,sans-serif",backgroundColor:"white",width:"48%",margin:"30px",borderRadius:"6px",boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px"}}>
          ...
          <TimingDiv>
           ...
           <ParallelDiv>
                ...
                <div style={{display:"flex",gap:"15px"}}>
                    ...
                    <SmallDiv style={{paddingTop:"28px"}}>
                        <p>Hospital Visit</p>
                        <p>₹ 1000</p>
                    </SmallDiv>
                </div>
