            ...
            <LeftDiv>
                    ...
                    <div style={{lineHeight:'36px',paddingTop:'20px',paddingLeft:'30px',paddingBottom:'10px'}}>
                        ...
                        <div style={{display:'flex'}}>   
                           ...
                           <div style={{marginLeft:'28%'}}>
                               <button style={{height:'45px',width:'90px',backgroundColor:'#fcb716',color:'white',fontWeight:'bold',border:'none',borderRadius:'7px',marginTop:'10px'}}>Pay ₹{}</button>
                           </div>
                ...
                <div style={{boxShadow: "rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px",marginTop:'20px'}}>
                    ...
                    <div style={{lineHeight:'36px',paddingTop:'20px',paddingLeft:'30px',paddingBottom:'20px'}}>
                       ...
                       <div style={{display: 'flex'}}>
                            <input type="number" style={{width:'70%',focus:'none',height:'34px',outline:'none',textarea:"focus",border:'2px solid #00b38e'}} /><br/>
                            <button style={{height:'42px',width:'120px',backgroundColor:'#fcb716',color:'white',fontWeight:'bold',border:'none',fontSize:'13px',borderRadius:'7px',marginLeft:'15px',marginTop:'10px',marginTop:'-3px'}}>VERIFY AND PAY</button>
                       </div>
